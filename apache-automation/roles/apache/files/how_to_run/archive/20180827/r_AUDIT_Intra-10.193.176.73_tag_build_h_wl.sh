...
ansible-playbook --tag="build_end_to_end" -i "${PATH_SELF}"/../../../../inventory/sdcgisazapmdw34_vm.ini "${PATH_SELF}"/../../../../Apache_WL_App_All_steps.yml  -u "touser" --private-key="${PATH_SELF}"/touserUID1002key_rsa  --become --extra-vars "appname_i=AUDITIntra env_dtup=DEV webservers=webservers_Inter WebLogicCluster=10.193.176.60:7121,10.193.176.61:7122"
